...
@endsection
@section('logo-title')
  Das einzige Interesse an Ihre Gesundheit und Ihr Glück
@endsection
@section('logo-img')
callus.jpg
@endsection
@section('logo-con')
  Unser Ziel ist es, alle medizinischen Versorgung Dienstleistungen Spezifikationen erste Abteilung zu schaffen und dafür zu sorgen, dass unsere Patienten die notwendige Behandlung in Krankenhäusern und Kliniken Deutsch erhalten
@endsection
@section('logo-links')
  <div class="row font" >
    <div class="col s12 center ">
      <a href="{{ route('about')  }}" class="waves-effect waves-light btn-large orange darken-2 white-text circle " target="_self">
        <i class="fa fa-question" aria-hidden="true"></i>
        <span style="line-height: 1.8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; من نحن ؟ &nbsp; </span>
      </a>

      <a href="{{ route('callus')  }}" class="waves-effect circle waves-light btn-large white orange-text darken-2   " target="_self" style="margin-left: 5px;">
  ...
  <div class="row white z-depth-5  grey lighten-4 " style="margin-top:0px !important;margin-bottom:0px;">
    <div class="row white-text hoverable font" style="margin-bottom: 0px;">
      <div class="col s12  m12  l12 serv" style="background-image: url({{ URL::to('img/trans.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align  orange-text flow-text" style="font-size: 22pt">خدمات ترجمة</h3>
          <div class="divider"></div>
          <p  class="left-align flow-text" style="font-size: 15pt" >نقدم لكم افضل خدمات الترجمة بالهاتف او مع مرافق يتحدث الالماني و العربي لكي نسهل عليكم التنقلات في المانيا في اي وقت و اي مكان في المانيا فقط اتصل بنا وسوف نرسل لك مساعد شخصي و مترجم</p>
          <br>
          <br>
          <div class="row center  center-align ">
            <a href="#" class="btn-css right  btn btn-large  white darken-2 orange-text waves-effect waves-dark btn-floating  tooltipped" data-position="bottom" data-delay="50" data-tooltip="اتصل بنا" ><i class= "material-icons  orange-text " style="font-size: 20px; margin-right: 20px; margin-top:3px;" aria-hidden="true" >phone</i>  </a>
          </div>
        </div>
      </div>
      <div class="col s12  m12  l6  serv" style="background-image: url({{ URL::to('img/med-check.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align orange-text flow-text" style="font-size: 22pt"> نقدم لكم افضل برامج العلاج </h3>
          <div class="divider"></div>
          <p  class="left-align flow-text" style="font-size: 15pt" >نقدم لكم افضل خدمات الترجمة بالهاتف او مع مرافق يتحدث الالماني و العربي لكي نسهل عليكم التنقلات في المانيا في اي وقت و اي مكان في المانيا فقط اتصل بنا وسوف نرسل لك مساعد شخصي و مترجم</p>
          <br>
          <br>
      ...
      <div class="col s12  m12  l6 serv" style="background-image: url({{ URL::to('img/doc2.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align  orange-text flow-text" style="font-size: 22pt">خدمات متابعة العلاج ما بعد السفر</h3>
          <div class="divider "></div>
          <p  class="left-align flow-text" style="font-size: 15pt" > بحيث نجمع جميع ملفاتك العلاجية و نخزنها عندنا وعندما تحتاج لها سوف نزودك بها اضافتاً الى مراجعة الاطباء من خلال الملفات ثم ارسال النتيجة لك  و باسرع وقت
            <br>
            <br>
      ...
      <div class="col s12  m12  l12 serv" style="background-image: url({{ URL::to('img/vip.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align orange-text flow-text" style="font-size: 22pt">خدمات خاصة لكبار الشخصيات</h3>
          <div class="divider"></div>
          <p  class="left-align flow-text" style="font-size: 15pt" >افضل الحدمات والمستلزمات لكبار الشخصيات و المشاهير لتسيل الامور في موعد الاطباء و الحجوزات و نقدم لهم مرافقة خاصة الى اي مكان مع مترجمين مختصين و خدمات النقل حتى من المطار وحجوزات الفنادق </p>
          <br>
          <br>
      ...
      <div class="col s12  m12  l6 serv" style="background-image: url({{ URL::to('img/car.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align orange-text flow-text" style="font-size: 22pt">خدمات تنقل سيارات مع سائق</h3>
          <div class="divider"></div>
          <p  class="left-align flow-text" style="font-size: 15pt" >ان كنت تريد التنقل في المانيا بشكل اسرع و منظم فهذا العرض سوف يعجبك لاننا نوفر طاقم عمل لنقل  المسافرين الى جميع مناطق المانيا لنقل اسرع وأمن ..</p>
          <br>
          <br>
      ...
      <div class="col s12  m12  l6 serv" style="background-image: url({{ URL::to('img/tour.jpg')  }});background-size: cover; background-repeat: no-repeat;">
        <div class="container"  >
          <h3 class="left-align orange-text flow-text" style="font-size: 22pt">خدمات السياحية والترفية</h3>
          <div class="divider"></div>
          <p  class="left-align flow-text" style="font-size: 15pt" >نقدم لكم جميع  الخدمات السياحية كالفنادق ومرافقه الى الاماكن السياحية و مدن الالعاب و الناضر الطبيعية الخلابة و كل شئ تتوقعونه من جمال المانيا من خدمات نقل من المطار</p>
          <br>
          <br>
