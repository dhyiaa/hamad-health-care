...
@section('logo-links')
    <div class="row font" >
        <div class="col s12 center ">
            <a href="{{ route('callus')  }}" class="waves-effect circle waves-light btn-large white-text orange darken-2   " target="_self" style="margin-left: 5px;">
    ...
    <div class="row white z-depth-5  grey lighten-4 " style="margin-top:0px !important;margin-bottom:0px;">
        <div class="row white-text hoverable font" style="margin-bottom: 0px;">
            <div class="col s12 m12 serv" style="background-image: url({{ URL::to('img/doc3.jpg')  }});background-size: cover; background-repeat: no-repeat;min-height:500px !important; height: auto; position: relative;">
                <div class="container"  >
                    <h3 class="left-align  orange-text flow-text" style="font-size: 22pt">يشمل البرنامج الاساسي</h3>
                    <div class="divider"></div>
                    <p  class="left-align flow-text" style="font-size: 15pt" >برنامج الفحص الطبي الشامل يقدم الفحوصات الطبية والفحوصات الخاصة للكشف المبكر عن الأمراض بأحدث الأجهزه الطبية
                        برنامج الفحص الطبي الشامل المطور ويتضمن عمل الفحوصات التالية</p>

                    <ul class="ul- left-align orange-text flow-text"  >
                    ...
                    <div class="divider"></div>
                    <p  class="left-align flow-text" style="font-size: 15pt" >برنامج الفحص الطبي الشامل يقدم الفحوصات الطبية والفحوصات الخاصة للكشف المبكر عن الأمراض بأحدث الأجهزه الطبية وأما بالنسبة الى الفحوصات الإضافية فهي متوفره حسب الطلب أوالحاجة وطبقاً للتاريخ الصحي والمرضي ولكنها لا تخضع للتكلفة الأساسية للبرنامج.</p>
                    <p class=" orange-text left-align flow-text" style="font-size: 15pt" >يفضل حجز الموعد قبل حضورك للمستشفى حتى نتمكن من خدمتكم بشكل أفضل.</p>
                    <br>
                    <br>
                    <br>
                    <br>
