...
<div class="row white z-depth-5  grey lighten-4 " style="margin-top:0px !important;margin-bottom:0px;">
    <div class="row white-text hoverable font" style="margin-bottom: 0px;">
        <div class="col s12 m12 serv" style="t:500px !important; height: auto; position: relative;">
            <div class="container"  >
            <h3 class="right-align  blue-text flow-text" style="font-size: 22pt"> استشارة طبية مجانية</h3>
            <div class="divider"></div>
            <p  class="right-align flow-text grey-text" style="font-size: 15pt" >يمكنكم الان وبكل بساطة  ومجاناً ان تستفسروا عن المشاكل الصحية التي تعانون وسوف نسال بها افضل اطباء المتخصصين في المانيا ثم نوافيكم بالتفاصيل مجاناً </p>
                ...
                <input  name="last_name" id="first_name" type="text" class=" black-text align-right validate">
                <label for="last_name" class="right-align" >الاسم  الاخير  </label>
                </div>
                <div class="input-field col s12 m6">
                <input  name="first_name" id="last_name" type="text" class=" black-text align-right validate">
                <label for="first_name" class=" right-align waves-input-wrapper">الاسم الاول </label>
                </div>
                </div>
                <div class="row">
                <div class="input-field col s12">
                <input id="email"  name="email" type="email" class=" black-text align-right validate">
                <label for="email" class=" right-align"> الايميل </label>
                </div>
                </div>
                <div class="row">
                <div class="row">
                <div class="input-field col s12">
                <textarea  name="ask" id="textarea1" class=" black-text align-right materialize-textarea"></textarea>
                <label style="position: absolute; right: 0px;float: right;text-align: right;" for="textarea1">وصف موجز ودقيق عن الحالة المرضية</label>
                </div>
                </div>
                </div>
                <div class="row">
