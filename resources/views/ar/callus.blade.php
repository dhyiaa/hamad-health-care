    ...
    <div class="row white z-depth-5  grey lighten-5 " style="margin-top:0px !important;margin-bottom:0px;">
        <div class="row white-text hoverable font" style="margin-bottom: 0px;">
            <div class="col s12 m12 serv"
                ...
                <div class="container">
                    <h3 class="right-align  orange-text flow-text" style="font-size: 22pt"> الايميل الخاص بنا </h3>
                    <div class="divider"></div>
                    <p class="right-align flow-text" style="font-size: 15pt">hamad_ala@yahoo.de </p>
                    <p class="right-align flow-text" style="font-size: 15pt">hamad_ala@yahoo.de </p>
                    <br>
                    <br>
                    <h3 class="right-align orange-text flow-text" style="font-size: 22pt"> ارقام الهاتف</h3>
                    <div class="divider"></div>
                    <p class="right-align flow-text" style="font-size: 15pt"><span>00491719640942</span>&nbsp;&nbsp; : &nbsp;&nbsp; واتس اب  </p>
                    <p class="right-align flow-text" style="font-size: 15pt"><span>00491737833333</span>&nbsp;&nbsp; : &nbsp;&nbsp; جوال  </p>
                    <p class="right-align flow-text" style="font-size: 15pt"><span>0049891499039110</span>&nbsp;&nbsp; : &nbsp;&nbsp; هاتف   </p>
                    <p class="right-align flow-text" style="font-size: 15pt"><span>00491499039115</span>&nbsp;&nbsp; : &nbsp;&nbsp; فاكس   </p>
                    <br>
                    <br>
                    <br>
                </div>
