...
@section('logo-links')
    <div class="row font" >
        <div class="col s12 center ">
            <a href="{{ route('about')  }}" title=" من نحن" class="waves-effect waves-light btn-large white blue-text darken-1   circle" target="_self">
                ...
                @foreach($partners as $partner)
                    <div class="col s12 m6 l4">
                        <div class="card activator  hoverable  ">
                            <div class="card-image activator  waves-green waves-effect waves-block waves-light " style="margin:0px;padding-top:0px;">
                            ...
                            <div class="card-reveal">
                                ...
                                <h2 style="text-align: right;font-size: 20pt" class="orange-text right-align" >{{  $partner->ar_title  }}</h2>
                                <p style="text-align: right;font-size: 16pt" clss="right-align grey right"  >{{  $partner->ar_more_info  }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
